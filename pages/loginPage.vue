        ...
        <div class="mx-auto max-w-md font-rubik">
          ...
          <form action="">
            <div class="my-4">
              ...
              <input class="border border-inp w-full p-2 mt-1" type="text" />
            </div>
            <div class="my-4">
            ...
            <button class="w-full py-5 bg-grBack text-white mt-7">Войти</button>
          </form>
        </div>
      </div>
    </div>
...
export default {
  name: 'loginPage',
  head: {
    title: 'Тендерная площадка - авторизация',
    meta: [
      { charset: 'utf-8' },
